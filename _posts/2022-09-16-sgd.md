...
where $$\rho$$ gives “friction” and $$\alpha$$ is the [**learning rate**](#learning_rate). "Friction" is the literal meaning to our car analogy. The higher the "friction", the lower the momentum velocity $$v$$. Typically, $$\rho = 0.9$$ or $$0.99$$.

There is an *alternative* way to formulate **SGD + Momntum**, 
...
where the [**learning rate**](#learning_rate) $$\alpha$$ only affects the **gradient** $$-nabla_\theta \mathcal{L}(\theta_t)$$.
...
By substituting into the above algorithm,
